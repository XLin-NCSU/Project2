...
From the two-way table, we can see that at each arena level, the number of players decreases when skill level increases. Most of the clanmates are in median arena level, indicating that my clan is not one of the top ranked clans. We have a long way to go.
