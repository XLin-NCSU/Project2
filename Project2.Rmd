...
This function enables you to get clan members' basic performance info by simply input the clan tag, clan member's role(leader, elder, member) and clan member's arena level(high, medium, low). The default argument will return all roles and all arena levels. Be careful that don't forget the single quotes when you input the clan tag. Correct format: `'#8YVVGR2Y'`
